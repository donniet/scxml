...
public class SCXMLExecutor implements Serializable {
    ...
    public void setEvaluator(final Evaluator evaluator) {
        ...
        if(this.stateMachine != null && this.scInstance.getEvaluator() != null) {
        	SCXMLHelper.runInitializationScripts(stateMachine.getDatamodel(), scInstance.getRootContext(), this.scInstance.getEvaluator(), this.log);
        }
    }
